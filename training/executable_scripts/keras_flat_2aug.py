...
df_train = pd.concat([helpers_tr.load_flat_features(tr1_features_files),
                      helpers_tr.load_flat_features(tr2_features_files)]).reset_index(drop=True)
...
df_train = helpers_tr.filter_out_features(df_train, 
                                          CFG_P.model_output_dir + 'lgbm_dart_2_statements_aug/model_log.json',
                                          imp_threshold = 2500) 
...
helpers_tr.train_save_flat_model(df_train, df_test,
                                 ...
                                 helpers_tr.get_keras_imp, 'keras_flat_2aug',
                                 cat_mode='ohe', runs_per_fold=5) 